...
if __name__ == "__main__":
    ...
    while True:
        try:
            frontClaw = Roboclaw("/dev/UART_OG", 115200)
            break
    ...
    rospy.loginfo("Subscribing to /rover/drive_directives/autonomous")
    rospy.Subscriber("/rover/drive_directives/autonomous", drive_msg, Drive_1.drive_callback)
    rospy.loginfo("Subscribed to /rover/drive_directives/autonomous")
    ...
    # rospy.loginfo("Subscribing to /rover/bio_config...")
    # rospy.Subscriber("/rover/bio_config", Int32, bio_command)
    # rospy.loginfo("Subscribed to /rover/bio_config")
    ...
    while not rospy.is_shutdown():
        ...
        #     else:
            ...
            rospy.sleep(0.01)
            debug_neww=frontClaw.ReadEncM2(0x84)
            rospy.sleep(0.01)
            if len(debug_neww)==3:
