    ...
    def soil_config(self):
        ...
        while True:
            ...
            if 1000 < enc1 < 1100:
                ...
                self.shoulder_elbow_actuators.SpeedM1(0x80, -int((enc1 - 1050) * 65 / abs(enc1 - 1050)))
            self.runtimer.sleep()
        print("...Shoulder Config Done")
    ...
    def arm_bio1(self):
        ...
        while True:
            ...
            if 940 < enc5 < 960:
                ...
                self.wrist_motor.SpeedM1(0x80, -int((enc5 - 950) * 40 / abs(enc5 - 950)))
            self.runtimer.sleep()
        ...
        while True:
            ...
            if 232 < enc1 < 252:
                ...
                self.shoulder_elbow_actuators.SpeedM1(0x80, -int((enc1 - 242) * 65 / abs(enc1 - 242)))
            self.runtimer.sleep()
        print("...Shoulder Config Done")
        ...
        while True:
            ...
            if -28950 < enc3 < -28450:
                ...
                self.base_elbow_motors.SpeedM1(0x80, -int((enc3 + 28700) * 2450 / abs((enc3 + 28700))))
            self.runtimer.sleep()
        print("...Base Config Done")
        ...
        while True:
            ...
            if 973 < enc2 < 993:
                ...
                self.shoulder_elbow_actuators.SpeedM2(0x80, -int((enc2 - 983) * 85 / abs(enc2 - 983)))
            self.runtimer.sleep()
        print("...Elbow Config Done")
        ...
        while True:
            ...
            if 604 < enc5 < 624:
                ...
                self.wrist_motor.SpeedM1(0x80, -int((enc5 - 614) * 40 / abs(enc5 - 614)))
            self.runtimer.sleep()
        print("...Wrist Config Done")
        print("Arm Bio Config 1 Completed")
    ...
    def arm_bio2(self):
        ...
        while True:
            ...
            if 197 < enc1 < 217:
                ...
                self.shoulder_elbow_actuators.SpeedM1(0x80, -int((enc1 - 207) * 65 / abs(enc1 - 207)))
            self.runtimer.sleep()
        print("...Shoulder Config Done")
        ...
        while True:
            ...
            if -44831 < enc3 < -44331:
                ...
                self.base_elbow_motors.SpeedM1(0x80, -int((enc3 + 44581) * 2450 / abs((enc3 + 44581))))
            self.runtimer.sleep()
        print("...Base Config Done")
        ...
        while True:
            ...
            if 967 < enc2 < 987:
                ...
                self.shoulder_elbow_actuators.SpeedM2(0x80, -int((enc2 - 977) * 85 / abs(enc2 - 977)))
            self.runtimer.sleep()
        print("...Elbow Config Done")
        ...
        while True:
            ...
            if 436 < enc5 < 456:
                ...
                self.wrist_motor.SpeedM1(0x80, -int((enc5 - 446) * 40 / abs(enc5 - 446)))
            self.runtimer.sleep()
        print("...Wrist Config Done")
    ...
    def arm_bio3(self):
        ...
        while True:
            ...
            if 195 < enc1 < 225:
                ...
                self.shoulder_elbow_actuators.SpeedM1(0x80, -int((enc1 - 209) * 65 / abs(enc1 - 209)))
            self.runtimer.sleep()
        print("...Shoulder Config Done")
        ...
        while True:
            ...
            if 24511 < enc3 < 25011:
                ...
                self.base_elbow_motors.SpeedM1(0x80, -int((enc3 - 24761) * 2450 / abs((enc3 - 24761))))
            self.runtimer.sleep()
        print("...Base Config Done")
        ...
        while True:
            ...
            if 950 < enc2 < 975:
                ...
                self.shoulder_elbow_actuators.SpeedM2(0x80, -int((enc2 - 963) * 85 / abs(enc2 - 963)))
            self.runtimer.sleep()
        print("...Elbow Config Done")
        ...
        while True:
            ...
            if 477 < enc5 < 517:
                ...
                self.wrist_motor.SpeedM1(0x80, -int((enc5 - 497) * 40 / abs(enc5 - 497)))
            self.runtimer.sleep()
        print("...Wrist Config Done")
    ...
    def arm_bio4(self):
        ...
        while True:
            ...
            if 42116 < enc3 < 42916:
                ...
                self.base_elbow_motors.SpeedM1(0x80, -int((enc3 - 42516) * 2450 / abs((enc3 - 42516))))
            self.runtimer.sleep()
        print("...Base Config Done")
        ...
        while True:
            ...
            if 965 < enc2 < 990:
                ...
                self.shoulder_elbow_actuators.SpeedM2(0x80, -int((enc2 - 974) * 85 / abs(enc2 - 974)))
            self.runtimer.sleep()
        print("...Elbow Config Done")
        ...
        while True:
            ...
            if 488 < enc5 < 508:
                ...
                self.wrist_motor.SpeedM1(0x80, -int((enc5 - 498) * 40 / abs(enc5 - 498)))
            self.runtimer.sleep()
        print("...Wrist Config Done")
    ...
    def arm_bio_uncontaminated(self):
        ...
        while True:
            ...
            if 440 < enc1 < 470:
                ...
                self.shoulder_elbow_actuators.SpeedM1(0x80, -int((enc1 - 455) * 65 / abs(enc1 - 455)))
            self.runtimer.sleep()
        print("...Shoulder Config Done")
        ...
        while True:
            ...
            if 723 < enc2 < 743:
                ...
                self.shoulder_elbow_actuators.SpeedM2(0x80, -int((enc2 - 733) * 85 / abs(enc2 - 733)))
            self.runtimer.sleep()
        ...
        while True:
            ...
            if 630 < enc5 < 650:
                ...
                self.wrist_motor.SpeedM1(0x80, -int((enc5 - 640) * 40 / abs(enc5 - 640)))
            self.runtimer.sleep()
        ...
        while True:
            ...
            if 785 < enc2 < 805:
                ...
                self.shoulder_elbow_actuators.SpeedM2(0x80, -int((enc2 - 795) * 85 / abs(enc2 - 795)))
            self.runtimer.sleep()
        print("...Elbow Config Done")
        ...
        while True:
            ...
            if 670 < enc5 < 710:
                ...
                self.wrist_motor.SpeedM1(0x80, -int((enc5 - 700) * 40 / abs(enc5 - 700)))
            self.runtimer.sleep()
        print("...Wrist Config Done")

    def iris_home(self):
        print("Setting up Iris Home Position 4...")
        ...
        while True:
            ...
            if 773 < enc2 < 793:
                ...
                self.shoulder_elbow_actuators.SpeedM2(0x80, -int((enc2 - 783) * 85 / abs(enc2 - 783)))
            self.runtimer.sleep()
        print("...Elbow Config Done")
            ...
            if self.wrist_motor is not None:
                ...
                if enc5 < 239:
                    ...
                    if self.wrist_actuator['direction'] == 'backward':
                        ...
                        self.wrist_motor.ForwardM1(0x80, 0)
            print(enc1,enc2,enc3,enc4,enc5)
